...
class auth
{
	var $user			= array(); //array where user details are stored
	...
	var $logon			= null; //array where user logon status
	...
	function validate($username, $password)
	{
		...
		$strQuery = "SELECT * FROM `users` WHERE `email`='{$username}' AND `pass`='{$password}'";
		$que = mysql_query($strQuery);
